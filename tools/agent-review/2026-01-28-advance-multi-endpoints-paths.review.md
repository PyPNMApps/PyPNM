...
- Goal: Refactor advance multi-capture endpoint paths to use /advance/multi/<name> and update docs.
- Changes: Updated router prefixes for multi RxMER, channel estimation, and OFDMA pre-eq; refreshed docs to match new paths.
- Files: src/pypnm/api/routes/advance/multi_rxmer/router.py; src/pypnm/api/routes/advance/multi_ds_chan_est/router.py; src/pypnm/api/routes/advance/multi_us_ofdma_pre_eq/router.py; docs/api/fast-api/multi/multi-capture-rxmer.md; docs/api/fast-api/multi/multi-capture-chan-est.md; docs/api/fast-api/multi/multi-capture-us-ofdma-pre-eq.md.
