...
- Goal: Convert SC-QAM docsIfDownChannelModulation to string values via a shared enum.
- Changes: Added DocsIfDownChannelModulation enum, normalized modulation output to strings, updated docs, and added tests.
- Files: src/pypnm/lib/constants.py, src/pypnm/docsis/data_type/DocsIfDownstreamChannel.py, docs/api/fast-api/single/ds/scqam/channel-stats.md, tests/test_docs_if_down_channel_modulation.py
...
# FILE: tests/test_docs_if_down_channel_modulation.py
# SPDX-License-Identifier: Apache-2.0
