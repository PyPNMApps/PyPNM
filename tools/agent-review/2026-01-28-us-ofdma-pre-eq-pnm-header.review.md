...
- Goal: Remove pnm_header suppression in US OFDMA pre-equalization response payload.
- Changes: Drop the commented pnm_header suppression line in the JSON response assembly.
- Files: src/pypnm/api/routes/docs/pnm/us/ofdma/pre_equalization/router.py
