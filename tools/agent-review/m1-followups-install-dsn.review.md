...
### Summary
Corrected Postgres DSN redaction to use a proper sed backreference and updated the env-var presence check to respect POSTGRES_DSN_ENV_VAR. This prevents passwords from persisting and aligns the warning logic with the configured env var name.
