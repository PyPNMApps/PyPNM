...
- Goal: Add requirement to run ruff/pytest after code changes and mkdocs build for Markdown-only changes.
- Changes: Updated testing expectations in AGENTS and CODING_AGENTS.
- Files: AGENTS.md; CODING_AGENTS.md.
