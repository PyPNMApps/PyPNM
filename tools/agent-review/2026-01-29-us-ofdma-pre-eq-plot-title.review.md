...
- Goal: Differentiate US Pre-Equalization vs Last Pre-Equalization plot titles and PNG filenames.
- Changes: Added optional plot filename tags, applied Pre-EQ file type tags, and asserted PNG filenames in tests.
- Files: src/pypnm/api/routes/advance/analysis/signal_analysis/multi_ofdm_chan_signal_analysis.py; src/pypnm/api/routes/advance/analysis/signal_analysis/multi_ofdma_pre_eq_signal_analysis.py; tests/test_multi_ofdma_pre_eq_analysis_data.py; docs/issues/index.md
...
# FILE: /home/dev01/Projects/PyPNM/src/pypnm/api/routes/advance/analysis/signal_analysis/multi_ofdm_chan_signal_analysis.py
