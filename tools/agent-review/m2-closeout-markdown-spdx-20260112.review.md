...
- Goal: Remove SPDX lines from Markdown DDL code blocks, enforce 2026 headers, and fix CaptureGroup docstring example.
- Changes: Stripped SPDX comment lines inside Appendix B/C SQL blocks and added a single DDL-source note, updated CaptureGroup header year to 2026, and fixed docstring method name.
- Files: docs/design/db/database-backend.md, src/pypnm/api/routes/common/classes/file_capture/capture_group.py
