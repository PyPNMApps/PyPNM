...
class CmSnmpOperation:
    ...
    async def setDocsIf3CmSpectrumAnalysisCtrlCmd(self,
        ...
        '''
        async def __snmp_set(field_name:str, obj_value:str | int, snmp_type:type, use_retry: bool = False) -> bool:
            ...
            if use_retry:
                set_response = await self._snmp.set_with_retry(oid, obj_value, snmp_type)
            else:
        ...
        try:
            ...
            for field_name, snmp_type in field_type_map.items():
                ...
                #######################################################################################
                    ...
                    if not await __snmp_set(field_name, Snmp_v2c.TRUE, snmp_type, use_retry=True):
                ...
                use_retry = field_name in [
                    "docsIf3CmSpectrumAnalysisCtrlCmdEnable",
                    "docsIf3CmSpectrumAnalysisCtrlCmdFileEnable",
                ]
                if not await __snmp_set(field_name, obj_value, snmp_type, use_retry=use_retry):
    ...
    async def setDocsPnmCmUsPreEq(self, ofdma_idx: int, filename:str, last_pre_eq_filename:str, set_and_go:bool=True) -> bool:
        ...
        try:
            ...
            if set_and_go:
                ...
                response = await self._snmp.set_with_retry(enable_oid, Snmp_v2c.TRUE, Integer32)
                result = Snmp_v2c.snmp_set_result_value(response)
    ...
    async def setDocsPnmCmDsOfdmModProf(self, ofdm_idx: int, mod_prof_file_name: str, set_and_go:bool=True) -> bool:
        ...
        try:
            ...
            if set_and_go:
                enable_response = await self._snmp.set_with_retry(enable_oid, Snmp_v2c.TRUE, Integer32)
    ...
    async def setDocsPnmCmDsOfdmRxMer(self, ofdm_idx: int, rxmer_file_name: str, set_and_go:bool=True) -> bool:
        ...
        try:
            ...
            if set_and_go:
                ...
                set_response = await self._snmp.set_with_retry(oid_file_enable, 1, Integer32)
    ...
    async def setDocsPnmCmOfdmChEstCoef(self, ofdm_idx: int, chan_est_file_name: str, set_and_go:bool=True) -> bool:
        ...
        try:
            ...
            if set_and_go:
                ...
                set_response = await self._snmp.set_with_retry(oid_trigger_enable, Snmp_v2c.TRUE, Integer32)
    ...
    async def setDocsPnmCmDsConstDisp(
        ...
        try:
            ...
            if set_and_go:
                ...
                set_response = await self._snmp.set_with_retry(oid, Snmp_v2c.TRUE, Integer32)
                result = Snmp_v2c.snmp_set_result_value(set_response)
                if not result or int(result[0]) != 1:
    ...
    async def setDocsCmLatencyRptCfg(self, latency_rpt_file_name: str, num_of_reports: int = 1, set_and_go:bool=True) -> bool:
        ...
        try:
            ...
            if set_and_go:
                ...
                set_response = await self._snmp.set_with_retry(oid_num_reports, num_of_reports, Gauge32)
                result = Snmp_v2c.snmp_set_result_value(set_response)
    ...
    async def setDocsPnmCmDsHist(self, ds_histogram_file_name: str, set_and_go:bool=True, timeout:int=10) -> bool:
        ...
        try:
            ...
            if set_and_go:
                ...
                set_response = await self._snmp.set_with_retry(oid_file_enable, Snmp_v2c.TRUE, Integer32)
    ...
    async def setDocsPnmCmDsOfdmSymTrig(self, ofdm_idx: int, symbol_trig_file_name: str) -> bool:
        ...
        try:
            ...
            set_response = await self._snmp.set_with_retry(oid_trigger_enable, 1, Integer32)
