...
- Goal: Align bootstrap docs with Phase 2 behavior and cover remaining M2 test gaps.
- Changes: Updated bootstrap contract terminology and fallback semantics, corrected design doc snapshot and ToC nesting, and added a DatabaseManager.close() invocation test.
- Files: docs/design/db/bootstrap-contract.md; docs/design/db/database-backend.md; tests/test_database_manager.py.
