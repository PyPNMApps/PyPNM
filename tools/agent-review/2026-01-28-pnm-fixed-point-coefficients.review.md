...
- Goal: Add regression coverage to validate fixed-point decoding for channel estimation and OFDMA pre-eq (current and last update) PNM files.
- Changes: Added a synthetic PNM payload test that verifies the first coefficient decodes with the correct fixed-point format for PNN2, PNN6, and PNN7.
- Files: tests/test_pnm_fixed_point_coefficients.py.
...
# FILE: tests/test_pnm_fixed_point_coefficients.py
