...
- Goal: Use friendly RBW calculation for OFDM/SC-QAM spectrum captures.
- Changes: Replaced RBWConversion usage with friendly RBW builder for OFDM/SC-QAM; updated OFDM RBW test; added channel RBW-friendly tests.
- Files: src/pypnm/api/routes/docs/pnm/spectrumAnalyzer/service.py, tests/test_ofdm_spectrum_analyzer_rbw.py, tests/test_spectrum_analyzer_rbw_friendly_channels.py
...
# FILE: tests/test_spectrum_analyzer_rbw_friendly_channels.py
# SPDX-License-Identifier: Apache-2.0
# Copyright (c) 2026 Maurice Garcia
