...
- Goal: Close Phase 2 hygiene by locking DSN contract invariants and cleaning import/headers.
- Changes: Added whitespace DSN fail-fast coverage for schema init and whitespace DSN fallback coverage for DatabaseManager; fixed Ruff I import ordering and normalized SPDX headers to 2026.
- Files: tests/test_database_manager.py; tests/test_db_schema_manager.py; src/pypnm/api/routes/common/classes/file_capture/pnm_file_transaction.py; src/pypnm/api/routes/docs/pnm/files/service.py.
