...
- Goal: Remove generic dict assembly in database settings accessors, normalize test setup state, and align examples/docs.
- Changes: Added typed DatabaseSettings.from_sources constructor, updated SystemConfigSettings to use it, reset deprecated-ledger warning state in tests, refreshed example IP placeholder, and tightened deprecated-key table spacing.
- Files: src/pypnm/config/system_config_settings.py; src/pypnm/config/database_settings.py; tests/test_system_config_settings.py; src/pypnm/examples/settings/system.json; docs/system/system-config.md.
...
# FILE: src/pypnm/config/database_settings.py
# SPDX-License-Identifier: Apache-2.0
# Copyright (c) 2026 Maurice Garcia
