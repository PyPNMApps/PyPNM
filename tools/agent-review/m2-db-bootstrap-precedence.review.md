...
- Goal: Harden DB bootstrap selection/healthcheck behavior, add precedence tests, and document the adapter bootstrap contract.
- Changes: Added backend precedence and failure-mode tests for DatabaseManager.initialize, documented adapter contract and bootstrap scope in design docs.
- Files: tests/test_database_manager.py; docs/design/db/database-backend.md.
