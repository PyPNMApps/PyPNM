...
### 2.2 Local Development Saves Versus Releases

`tools/git/git-save.sh` and `tools/release/release.py` serve different purposes.
...
* updates version files for the release
* runs release checks
